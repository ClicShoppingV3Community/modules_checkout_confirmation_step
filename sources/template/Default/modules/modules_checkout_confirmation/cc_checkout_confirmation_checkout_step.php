<?php
/**
 * cc_checkout_confirmation_checkout_step.php
  ...
  class cc_checkout_confirmation_checkout_step {
    ...
    public function execute() {
      ...
      if (isset($_GET['Checkout']) && isset($_GET['Confirmation']) && $CLICSHOPPING_Customer->isLoggedOn() ) {
        ...
        ob_start();
        require($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/checkout_confirmation_checkout_step'));
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_CHECKOUT_CONFIRMATION_CHECKOUT_STEP_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_CHECKOUT_CONFIRMATION_CHECKOUT_STEP_CONTENT_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_CHECKOUT_CONFIRMATION_CHECKOUT_STEP_SORT_ORDER',
          'configuration_value' => '380',
    ...
    public function keys() {
      return array (
        'MODULE_CHECKOUT_CONFIRMATION_CHECKOUT_STEP_STATUS',
        'MODULE_CHECKOUT_CONFIRMATION_CHECKOUT_STEP_CONTENT_WIDTH',
        'MODULE_CHECKOUT_CONFIRMATION_CHECKOUT_STEP_SORT_ORDER'
      );
    }
  }
